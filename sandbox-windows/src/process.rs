...
pub struct CreatedProcess {
    ...
    /// Job the process was atomically attached to at creation; closing the
    /// last handle (or calling `terminate`) kills the whole process tree.
    pub job: std::sync::Arc<crate::job::JobObject>,
