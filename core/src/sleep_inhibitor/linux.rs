// Ported from codex-rs/utils/sleep-inhibitor/src/linux_inhibitor.rs (Apache-2.0, OpenAI)
// NOTICE: This file contains code derived from the OpenAI Codex project.
// Changes: renamed APP_ID and assertion reason to Meridian.
