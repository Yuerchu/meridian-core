// Ported from codex-rs/utils/sleep-inhibitor/src/windows_inhibitor.rs (Apache-2.0, OpenAI)
// NOTICE: This file contains code derived from the OpenAI Codex project.
// Changes: adapted from windows-sys 0.61 to 0.52 (HANDLE is isize, so null
// checks compare against 0); renamed assertion reason to Meridian.
...
const ASSERTION_REASON: &str = "Meridian is running an active turn";
...
impl PowerRequest {
    fn new_system_required(reason: &str) -> Result<Self, String> {
        ...
        // windows-sys 0.52: HANDLE is isize; 0 is the null handle.
